...
const MESSAGES = {
  zh: {
    ...
    "pwd.layer_classic": "加密保存所有消息",
    "pwd.layer_private": "加密保存隐私消息",
    "pwd.layer_hint": "启用后需先点击“关闭密码保护”并输入当前密码，才能切换到另一种。",
    "pwd.status_disabled": "未启用——数据以明文存储在本地",
    "pwd.status_enabled": "已启用——对话记录与设置已加密存储",
    "pwd.status_disabled_private": "未启用——隐私对话仅保存在内存中，刷新页面或关闭浏览器后即消失",
    "pwd.status_enabled_private": "已启用——隐私对话已加密存储",
    ...
    "pwd.disable_private_confirm": "关闭后，之前加密保存的隐私对话会恢复显示，但从此不再持久化保存——只留在当前会话内存中，刷新页面或关闭浏览器后将永久丢失。确定要关闭吗？",
    "pwd.use_enable_btn": "请点击上方“开启密码保护”按钮生效，下方“保存”按钮不会启用密码保护",
    "pwd.use_change_or_disable_btn": "请点击上方“修改密码”或“关闭密码保护”按钮生效，下方“保存”按钮不会修改密码",

    "private.button_title": "隐私模式",
    "private.settings_title": "隐私模式",
    "private.hide_button_label": "隐藏隐私模式按钮",
    "private.hide_button_hint": "开启后，顶部不再显示隐私模式按钮，改为在对话搜索框上连续点击三下进入/退出隐私模式。",
    "private.unlock_title": "进入隐私模式",
    "private.unlock_password_label": "密码",
    "private.unlock_confirm": "解锁",
  ...
  en: {
    ...
    "settings.auto_compress_hint": "If chat history exceeds this length, it's summarized first to save tokens. Pro models: 96000 and up. Simple models: 64000 or less. Minimum 10000.",
    ...
    "pwd.layer_classic": "Encrypt all chats",
    "pwd.layer_private": "Encrypt private chats only",
    "pwd.layer_hint": "To switch, click \"Disable protection\" first.",
    ...
    "pwd.status_disabled_private": "Disabled — private chats live only in memory and disappear on page refresh or browser close.",
    "pwd.status_enabled_private": "Enabled — private chats are encrypted and saved to disk.",
    ...
    "pwd.disable_private_confirm": "Disabling will bring your encrypted private chats back into view, but from then on they're no longer saved to disk — they live only in this session's memory and will be permanently lost on refresh or browser close. Disable anyway?",
    "pwd.use_enable_btn": "Click \"Enable password protection\" above to apply it — the \"Save\" button below won't enable it",
    "pwd.use_change_or_disable_btn": "Click \"Change password\" or \"Disable protection\" above to apply it — the \"Save\" button below won't change it",

    "private.button_title": "Private mode",
    "private.settings_title": "Private mode",
    "private.hide_button_label": "Hide the private-mode button",
    "private.hide_button_hint": "When enabled, hide the private-mode button; use triple-click on the <b>Search Bar</b> instead.",
    "private.unlock_title": "Enter private mode",
    "private.unlock_password_label": "Password",
    "private.unlock_confirm": "Unlock",
